    ...
    "signals": [
      ...
      },
      {
        ...
        "on": [
          {
            "events": "wheel!",
            "update": "zoom * clamp(pow(1.001, -event.deltaY), 0.1, 10)"
          }
        ]
      },
      {
    ...
    "data": [
      ...
      },
      {
        ...
        "transform": [
          ...
          { "type": "filter", "expr": "datum.depth <= clamp(floor(zoom), 0, 3) || datum.depth ==0" }
      ]
      },
      {
        "name": "leaves",
        ...
        "transform": [
          // { "type": "filter", "expr": "!datum.children" }
          { "type": "filter", "expr": "datum.depth <= clamp(floor(zoom), 0, 3)" }
        ]
      }
    ],
    ...
    "marks": [
      ...
      },
      {
        ...
        "encode": {
          ...
          "update": {
            // "text": { "signal": "clamp(floor(zoom), 0, 3)" },
            // "text": { "field": "depth" },
